...
// MongoDB connection is handled by connectDB() above
// The hardcoded connection has been removed to use the .env configuration

const app = express();
const server = http.createServer(app);

// Initialize Socket.IO with dynamic CORS for development and production
